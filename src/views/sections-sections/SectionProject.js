...
function SectionProject() {
  ...
  return (
    <>
      <div className=" section-dark cd-section" id="projects"> 
        {/* //section removed */}
        {/* ********* PROJECTS 1 ********* */}
          ...
          <Container >
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                <h2 className="title" style = {{fontSize: 60}}>Adding Life To Food</h2>
            ...
            <Row>
              <Col md="5">
                ...
                >
                  <CardBody>
                    <h6 className="card-category">Farmers</h6>
                    <a href="#pablo" onClick={(e) => e.preventDefault()}>
                      <CardTitle tag="h3" style = {{ color: "#C0C0C0", fontWeight: 500}}>The Best Productivity Apps</CardTitle>
                    </a>
                    <br />
                    <p className="card-description" style = {{fontSize: 16, color: "#D3D3D3", fontWeight: 500}}>
                      Don't be scared of the truth because we need to restart
                      the human foundation in jsiejg skjngis jhrj 
                    </p>
                    <br />
                    <Button
                      className="btn-round"
              ...
              <Col md="7">
                ...
                >
                  <CardBody>
                    <h6 className="card-category">Fruits</h6>
                    <CardTitle tag="h3" style = {{ color: "#C0C0C0", fontWeight: 500}}>
            ...
            <Row>
              <Col md="7">
                ...
                >
                  <CardBody>
                    <h6 className="card-category">Environment</h6>
                    <a href="#pablo" onClick={(e) => e.preventDefault()}>
                      <CardTitle tag="h3" style = {{ color: "#C0C0C0", fontWeight: 500}}>MateLabs mixes machine</CardTitle>
                    </a>
                    <br />
                    <p className="card-description" style = {{fontSize: 16, color: "#D3D3D3", fontWeight: 500}}>
                      If you’re not familiar with IFTTT, it’s an automation tool
                      for creating your own if/then statements 
                    </p>
                    <br />
                    <Button
                      className="btn-round"
              ...
              <Col md="5">
                <Card
                  ...
                  style={{
                    backgroundImage:
                      "url(" +
                      require("assets/kimaye/consumer.jpeg") +
                      ")",
                  }}
                >
                  <CardBody>
                    <h6 className="card-category">Consumer</h6>
                    <CardTitle tag="h3" style = {{ color: "#C0C0C0", fontWeight: 500}}>
                    ...
                    <p className="card-description" style = {{fontSize: 16, color: "#D3D3D3", fontWeight: 500}}>
                      ...
                      easy to accept/decline, schedule a time 
                    </p>
                    <br />
                    <Button
                      className="btn-round"
