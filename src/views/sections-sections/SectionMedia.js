    ...
    <>
      ...
      <div className={`blog-2 ${styles.BlogSection}`} style={{
        ...
        <div className={styles.JourneyContainer}>
          <h2
            id="journeyJump"
            style={{ color: "#dbac00", fontWeight: "500", textAlign: "center" }}
          >
            The Journey...
          </h2>
                    ...
                    <Card key={card.id} className="card-blog">
                      ...
                      <CardBody>
                        ...
                        <p
                          ...
                          style={{ color: "black" }}
                        >{`${card.content.substring(0, 200)}...`}</p>
                      </CardBody>
                    </Card>
                  );
                })}
                  ...
                  povDB
                    ...
                    .map((card) => {
                      return (
                        <Card
                          key={card.id}
                          className={`${styles.povCard} card-plain card-blog`}
                        >
                          <Col md="4">
                            <div className="card-image">
                              <img
          ...
          <div className={styles.VidCont}>
            {mediaDB &&
              mediaDB
                ...
                .slice(0, mPerPage)
                .map((vid, ind) => {
                  console.log(vidLink(vid.media));
                  return (
                    <div className={styles.iframeContainer}>
                      {vid.media.includes("pdf") && (
                        <a target="_blanck" href={vidLink(vid.media)} download={`media-${ind}`}>
                          <button className={styles.iframeButton}>⭳</button>
                        </a>
                      )}
                      <iframe
                        key={vid.id}
                        title={`video-${ind + 1}`}
                        className={`${
                          vid.media.includes("pdf") ? styles.containsPdf : ""
                        }`}
                        style={{
                          borderRadius: "10px",
                          borderColor: "#000",
